...
final class CoreModelTests: XCTestCase {
    ...
    func testHomePreferencesAreLocalFirstAndSyncReady() throws {
        ...
        XCTAssertFalse(preferences.isSectionEnabled("watchNext"))
        XCTAssertTrue(preferences.isSectionEnabled("recommended"))
        XCTAssertTrue(preferences.isSectionEnabled("collections"))
